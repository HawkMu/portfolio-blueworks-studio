...
https://hawkmu.github.io/portfolio-blueworks-studio/
...
- 本サイトは架空のWeb制作会社を想定した学習用制作物です。
- 実在する企業・サービスとは関係ありません。
- Contactフォームは見た目とJavaScriptの動作確認を目的としており、実際の送信処理は行っていません。
- 画像素材は使用せず、CSSによる装飾で表現しています。

## 制作プロセス

本制作では、以下の流れで作業を行いました。

1. 企画・構成整理
2. 画面設計・HTML設計・CSS設計
3. HTMLによる各セクションの実装
4. CSSによるレイアウト・デザイン調整
5. JavaScriptによるメニュー開閉・フォーム動作の実装
6. PC / スマートフォン表示確認
7. GitHub Pagesで公開

## AI利用について

本制作では、設計書作成、実装方針の確認、コードレビュー、一部コード例の提示にAIを活用しました。
...
https://github.com/HawkMu/portfolio-blueworks-studio